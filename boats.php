...
<?php
    ...
    switch ($method) {
        case 'POST': // Create - Add
            ...
            try {
                $sql = "INSERT INTO boats (userid, name, img, start_city, start_cap, destination) VALUES (:userid, :name, :img, :start_city, :start_cap, :destination)";
        ...
        case 'DELETE': // Delete
            ...
            // Remove from the DB
            $sql = "DELETE FROM boats WHERE id = :id AND userid = :userid";
            $stmt = $conn -> prepare($sql);
            $stmt -> execute([
                "id" => $id,
                "userid" => $userid,
